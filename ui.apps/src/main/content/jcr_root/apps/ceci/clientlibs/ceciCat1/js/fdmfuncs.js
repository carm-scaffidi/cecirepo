...
var vEgcs_fo_profileid = "68995d00-b104-eb11-96a4-00505681cf84"; //Call for Proposal: 'CFP 2021'
...
function createProposal() {
  ...
  var egcs_fc_profileArray = {
    ...
    "egcs_FundingOpportunity": { "egcs_fo_profileid": "68995d00-b104-eb11-96a4-00505681cf84" },
...
function createCompTRN(componentNode) {
  var fdiProjCompArray = {
    ...
    "gac_CallForProposal": { "egcs_fo_profileid": "68995d00-b104-eb11-96a4-00505681cf84" },
    "gac_Program": { "egcs_tp_profileid": "1edcab5b-80a4-ea11-969c-005056816b76" },
...
/* function createComponent(componentObj, gacName) {
  var fdiProjCompArray = {
    "gac_name": "FDI Strategic Planning and Analysis",
    "gac_expectednumberofmeetings": 2,
    "gac_expectednumberofprospectsreached": 3,
    "gac_expectednumberofpeopletrained": 7,
    "gac_expectedcomponentcost": 10.00,
    "gac_fdicomponentamountrequested": 20.00,
    "gac_fdicomponentamountapproved": 30.00,
    "gac_pastexperience": "There is a lot of experience, but not relevant to this :)",
    "gac_objective": "gac_objective. Funding for foreign investment",
    "gac_Proposal": { "egcs_fc_profileid": vEgcs_fc_profileid },
    "gac_CallForProposal": { "egcs_fo_profileid": "68995d00-b104-eb11-96a4-00505681cf84" },
    "gac_Program": { "egcs_tp_profileid": "1edcab5b-80a4-ea11-969c-005056816b76" },
    "gac_Applicant": { "accountid": strProposal.proposal.globalids.accountid},
    "gac_FDIComponentCategory": { "gac_fdicomponentcategoryid": "b5a3174d-9101-eb11-b82b-005056bf50dd" },
    "gac_CallYear": { "gac_timeperiodid": "62145559-b004-eb11-96a4-00505681cf84" }
  };
  // only shows [object,object]...console.log("fdiProjCompArray:"+fdiProjCompArray);
  var componentFormData = JSON.stringify({
  ...
  $.ajax({
    ...
    error: function (XMLHttpRequest, textStatus, errorThrown) {
      console.log("Error-POST gac_fdiprojectcomponent-createComponent");
    },
    cache: false,
    async: false
  });
...
upon submit, when a componet is created in Dynajmics,
